...
$(document).ready(function(){	
	...
	$("#mobileAuthNoCheck").on("click", function() {
		...
		if(getAuthNum("sms", userPhone, mobileAuthNo) == "PASS") {
			window.document.location.href="/cubici/mypage/auth";
		}else{
				...
				<article>
					<div class="formMaxWrap2">
						<div class="middleBtnArea">
							<a href="javascript:;" class="wBtn mBtn imgBtn tColorN mobileAuthNoBtn">인증번호 받기</a>
						</div>
					</div>
				</article>
						...
						<ul class="item">
							<li class="btn">
								...
								<div class="fwBtn col-1">
									<a href="javascript:;" class="sBtn sColorLS2 mobileAuthNoBtn">재전송</a>
								</div>
							</li>
						</ul>
					</div>
