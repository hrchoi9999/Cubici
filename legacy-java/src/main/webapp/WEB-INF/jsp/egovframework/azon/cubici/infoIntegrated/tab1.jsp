...
<!--사용 차트-->
<script src="/resources/chart/combo-bar-line.js"></script>
...
<div class="m-options">
   <span class="baseDate pRight"><b>기준</b>${standardDate}</span><!-- 기준 : 전날 -->
</div>
    ...
    <table class="m-shadowTable">
        ...
        <tbody>
            ...
            <tr class="bgGray">
                ...
                <td><div class="tIn"><span class="tColorR" id = "changeProductCount"></span></div></td>
            </tr>
        </tbody>
    </table>
</article>
