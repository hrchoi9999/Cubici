...
CREATE TABLE IF NOT EXISTS "column_stats" (
  ...
  "hist_size" smallint,
  "hist_type" enum('single_prec_hb','double precision_prec_hb'),
...
CREATE TABLE IF NOT EXISTS "db" (
  ...
  "Delete_history_priv" enum('n','y') NOT NULL,
  PRIMARY KEY ("Host", "Db", "User")
);
CREATE INDEX IF NOT EXISTS "idx_db_User" ON "db" ("User");
...
CREATE INDEX IF NOT EXISTS "idx_help_category_name" ON "help_category" ("name");

CREATE TABLE IF NOT EXISTS "help_keyword" (
  "help_keyword_id" integer NOT NULL,
  "name" char(64) NOT NULL,
  PRIMARY KEY ("help_keyword_id")
);
CREATE INDEX IF NOT EXISTS "idx_help_keyword_name" ON "help_keyword" ("name");
...
CREATE INDEX IF NOT EXISTS "idx_help_relation_help_topic_id" ON "help_relation" ("help_topic_id");
...
CREATE INDEX IF NOT EXISTS "idx_help_topic_name" ON "help_topic" ("name");
...
CREATE TABLE IF NOT EXISTS "innodb_table_stats" (
  ...
  "clustered_index_size" bigint NOT NULL,
  "sum_of_other_index_sizes" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "proc" (
  ...
  "db_collation" char(32),
  "body_utf8" bytea,
  "aggregate" enum('none','group') NOT NULL,
...
CREATE TABLE IF NOT EXISTS "procs_priv" (
  ...
  "Proc_priv" set('execute','alter routine','grant') NOT NULL,
  "Timestamp" timestamp NOT NULL,
  PRIMARY KEY ("Host", "Db", "User", "Routine_name", "Routine_type")
);
CREATE INDEX IF NOT EXISTS "idx_procs_priv_Grantor" ON "procs_priv" ("Grantor");
...
CREATE TABLE IF NOT EXISTS "proxies_priv" (
  ...
  "With_grant" smallint NOT NULL,
  "Grantor" char(141) NOT NULL,
  "Timestamp" timestamp NOT NULL,
  PRIMARY KEY ("Host", "User", "Proxied_host", "Proxied_user")
);
CREATE INDEX IF NOT EXISTS "idx_proxies_priv_Grantor" ON "proxies_priv" ("Grantor");
...
CREATE TABLE IF NOT EXISTS "roles_mapping" (
  ...
  "Admin_option" enum('n','y') NOT NULL
);
CREATE INDEX IF NOT EXISTS "idx_roles_mapping_Host" ON "roles_mapping" ("Host", "User", "Role");
...
CREATE TABLE IF NOT EXISTS "tables_priv" (
  ...
  "Grantor" char(141) NOT NULL,
  "Timestamp" timestamp NOT NULL,
  "Table_priv" set('select','insert','update','delete','create','drop','grant','references','index','alter','create view','show view','trigger','delete versioning rows') NOT NULL,
  "Column_priv" set('select','insert','update','references') NOT NULL,
  PRIMARY KEY ("Host", "Db", "User", "Table_name")
);
CREATE INDEX IF NOT EXISTS "idx_tables_priv_Grantor" ON "tables_priv" ("Grantor");
...
CREATE TABLE IF NOT EXISTS "time_zone_transition" (
  "Time_zone_id" integer NOT NULL,
  "Transition_time" bigint NOT NULL,
  "Transition_type_id" integer NOT NULL,
