...
관리자 캡처 11장과 route 매핑이 아직 확정되지 않아 Prism 2개 외 화면 복원율은 20% 이하로 둔다.

| ID | 메뉴/화면 | Route | 화면 복원율 | 기능 구현율 | 주요 잔여 |
|---|---|---|---:|---:|---|
| A01 | 통합정보/큐빅아이 | `/admin/cubici/infoIntegrated/cubici_tab1` | 20% | 50% | 캡처 매핑, chart 산식 |
| A02 | 통합정보/머니뱅크 | `/admin/cubici/infoIntegrated/moneybank_tab1` | 20% | 55% | 캡처 매핑, chart 산식 |
| A03 | 회원관리/회원현황 | `/admin/cubici/manageMember/member_tab1` | 20% | 75% | 상세 write/시각 승인 |
| A04 | 회원관리/결제관리 | `/admin/cubici/manageMember/payment_tab1` | 20% | 50% | 결제 원천/취소 검증 |
| A05 | 머니뱅크 관리/통합 현황 | `/admin/moneybank/cubici/management/info_tab1` | 20% | 70% | 캡처 매핑/산식 |
| A06 | 머니뱅크 관리/이용상세 | `/admin/moneybank/management/usageList` | 20% | 75% | 목록/상세 이미지 승인 |
| A07 | 신청 접수 | `/admin/moneybank/request` | 20% | 80% | Batch 11-5B smoke |
| A08 | 심사 승인 | `/admin/moneybank/approval_tab1` | 20% | 75% | Batch 11-5B smoke |
| A09 | 계약 관리 | `/admin/moneybank/approval_tab2` | 20% | 70% | Batch 11-5B smoke |
| A10 | 정산 관리 | `/admin/moneybank/settlement` | 20% | 70% | Batch 11-5B smoke/산식 |
| A11 | 상환 관리 | `/admin/moneybank/redemption` | 20% | 75% | Batch 11-5B smoke/산식 |
| A12 | 프리즘 지표 관리 | `/admin/moneybank/manage` | 60% | 70% | 방향 승인, 세부 보정 필요 |
| A13 | 고객문의 | `/admin/cubici/supportMember/manageInquiry` | 20% | 70% | 캡처 매핑/코드 검산 |
| A14 | 문자/이메일 | `/admin/cubici/supportMember/manageSms` | 20% | 65% | 실제 발송 제외/시각 승인 |
| A15 | 고객 공지 관리 | `/admin/cubici/supportMember/manageBoard_tab1` | 20% | 65% | 첨부/FAQ 파생 화면 |
| A16 | Error Log | `/admin/cubici/adminMonitor/error_report` | 20% | 55% | 운영 로그/시각 승인 |
| A17 | 서버 관리 | `/admin/cubici/adminMonitor/server_monitor` | 20% | 45% | OS metric/반응형 |
| A18 | 펌뱅킹 전문 | `/admin/cubici/adminMonitor/fintech_trade` | 20% | 50% | 기능/E2E 재평가 |
| A19 | 관리자 등록 | `/admin/cubici/adminPreference/adminRegister_tab1` | 20% | 55% | live CRUD/권한 |
| A20 | 요금제 관리 | `/admin/cubici/adminPreference/manageCharge` | 20% | 55% | live CRUD/삭제정책 |
| A21 | 연계코드 관리 | `/admin/cubici/adminPreference/managePromotion` | 20% | 55% | live CRUD/코드 매핑 |
| A22 | 협력사 관리 | `/admin/cubici/adminPreference/managePartner` | 20% | 55% | live CRUD/주소검증 |
| A23 | 머니뱅크 관리 설정 | `/admin/cubici/adminPreference/manageMoneybank_tab1` | 20% | 50% | 상태/수수료 매핑 |
| A24 | Prism System | `/admin/cubici/adminPreference/prizmConfig` | 60% | 50% | 방향 승인, RawData/Excel 검증 |
