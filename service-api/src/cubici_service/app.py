...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    # The last middleware added wraps authentication rejection responses too.
    if resolved_settings.cors_allow_origins or resolved_settings.cors_allow_origin_regex:
        app.add_middleware(
            CORSMiddleware,
