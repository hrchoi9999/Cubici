...
<!--사용 차트-->
<script src="/resources/rudicks/mobile/js/chart/doughnut.js"></script>
<script src="/resources/rudicks/mobile/js/chart/line-style.js"></script>
<script src="/resources/rudicks/mobile/js/chart/bar-horizontal.js"></script>
...
<div class="m-search">
    <ul>
        <li>
           <div class="fwBox">
                <span class="ft"style="font-size:0.2rem;">기준</span>
                <div class="input">
        ...
        <li>
            <div class="fwBox">
                <span class="ft" style="font-size:0.2rem;">쇼핑몰</span>
                <div class="input">
        ...
        <li>
            <div class="fwBox">
                <span class="ft"style="font-size:0.2rem;">시작</span>
                <div class="input">
                    <input type="text" class="datepicker" placeholder="시작기간" id="fromDate" autocomplete="off" readonly>
                </div>
            </div>
        </li>
        <li>
            <div class="fwBox">
                <span class="ft" style="font-size:0.2rem;">종료</span>
                <div class="input">
                    <input type="text" class="datepicker" placeholder="종료기간" id="toDate" autocomplete="off" readonly>
                </div>
            </div>
        </li>
        <li class="btns">
              <button class="mBtn sColorLB wBtn search" id="selectButton">검색</button>
        </li>
    </ul>
</div>
...
<article class="subBox">
    <header>
        ...
        <ul class="btns">
            <li class="infoArea">
                <a href="javascript:;" class="oiBtn infoBtn white">정보</a>
                <div class="infoMemo">
                    <h5 class="mt"><span>재고상품 산출방법</span></h5>
                    <div class="iCon">
                        <p>
                        	재고상품은 등록하신 상품의 판매금액과 
                        	각 쇼핑몰의 재고수량을 기준으로 산출됩니다. 
                        	보다 정확한 분석을 위해서는  <b><a href="/cubici/invento/index">"재고현황" </a></b>
                        	페이지를 통해서 동일한 상품은  
                        	“선택상품 매칭”을 통해 묶음처리 해주시고, 
                        	재고수량은 해당 상품명을 클릭해서 
                        	"본사재고" 수량을 수정해 주십시오. 
                        </p>
                    </div>
             ...
             <li>
                <a class="iBtn excel" style="cursor: pointer" id="topStockExcelBtn">엑셀 다운로드</a>
    ...
    <div class="contentArea">
        <div class="chartBox">
            <canvas id="bar-horizontal2"></canvas>
        </div>
    </div>
</article>