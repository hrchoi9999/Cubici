...
$(document).ready(function(){
	...
	// 로그인, 아이디 저장
	if(getCookie("01AID") !== null){
		$("#userId").val(getCookie("01AID"));
...
<body>
	<div class="adminIntroContents">
        <input type="hidden" id="ADMIN_TYPE" value="01">
        <input type="hidden" id="ADMIN_NAME" value="투게더펀딩">
        <div class="loginWrapper">
            <div class="logoBox">
                <img src="/resources/rudicks/admin/img/logo-together.png" alt="">
            </div>
            <div class="titleBox">
