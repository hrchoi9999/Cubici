			...
			<div class="mInner mArticleArea tabArea">
				<article class="m-modalGrid">
					...
					<div class="contentsArea">
						<input type="hidden" id="object_no" value="${userDetail.object_no}" />
				...
				<article class="m-tab">
					<ul>
						...
						<li>
							<h2>
								<a id="paytab" href="javascript:;">결제현황</a>
							</h2>
						</li>
						<li>
							<h2>
				...
				<!-- 결제현황 -->
				<jsp:include page="/WEB-INF/jsp/egovframework/azon/admin/cmmn/paymentInfo.jsp"/>
